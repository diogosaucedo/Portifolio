  ...
  return (
    <Container>
      ...
      <Menu>
        ...
        <Exit className={isOpen ? "visible" : "invisible"} onClick={toggleMenu}>
          [Fechar]
        </Exit>
        <MenuItems className={isOpen ? "visible" : "invisible"}>
          <Link onClick={toggleMenu} href="#sobre-mim">
            <MenuItem>Sobre Mim</MenuItem>
          </Link>
          <Link onClick={toggleMenu} href="#projetos">
            <MenuItem>Projetos</MenuItem>
          </Link>
          <Link onClick={toggleMenu} href="#servicos">
            <MenuItem>Serviços</MenuItem>
          </Link>
          <Link onClick={toggleMenu} href="#minhas-skills">
